...
# from lib.utils import load_excel, filter_data, plot_data_spectra
from lib_cc_fit import utils

# load_excel, filter_data, plot_data_spectra
...
data = utils.load_excel(clay_cont,min_freq=min_freq,max_freq=max_freq)    
sat = data['sat']
path = './'
